...
public actor SSHConnectionPool {
  public static let shared = SSHConnectionPool()
  ...
  public func manager(for config: SSHServerConfiguration) -> SSHConnectionManager {
  ...
  public func connect(_ config: SSHServerConfiguration) async throws {
  ...
  public func disconnect(serverConfigID: UUID) async {
  ...
  public func isConnected(serverConfigID: UUID) async -> Bool {
